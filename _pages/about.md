...
<b>Interested in my lab?</b> I'm looking for motivated students with a strong background (i.e., excellent grades and/or relevant experience) in computer science, applied mathematics or statistics. If you're interested in working in my lab as a PhD student, PostDoc, master thesis or HiWi, reach out to me with your CV, transcripts of records for <b> all degrees </b>, and a short statement of motivation. For prospective master thesis and HiWi, state <b> the desired start date and any other commitments you will have during the thesis or HiWi. Due to the large number of applications, I will not reply to emails that do not state this information.</b>
...
25/03/2026: Attending the SatML 2026 conference in Munich, Germany, where I have chaired the differential privacy session.

09/03/2026: Our [paper](https://www.arxiv.org/abs/2512.05707) evaluating training data filtering defenses for preventing child sexual abuse material generation by text-to-image models has been accepted for publication at IEEE SP 2026. Stay tuned for the updated version and the code.

01/01/2026: I have started a new position as a tenure-track faculty at [CISPA](https://cispa.de/en) in Saarbrucken, Germany. I am delighted to join such a stellar team of researchers!
